...
" Initialization
"=============================================================================
command! -nargs=? Bp python3 debugger_mark('<args>')
command! -nargs=0 Up python3 debugger_up()
command! -nargs=0 Dn python3 debugger_down()
...
if g:debuggerDisableDefaultMappings == 0
	map <F1> :python3 debugger_resize()<cr>
	map <F2> :python3 debugger_command('step_into')<cr>
	map <F3> :python3 debugger_command('step_over')<cr>
	map <F4> :python3 debugger_command('step_out')<cr>
	map <F5> :python3 debugger_run()<cr>
	map <F6> :python3 debugger_quit()<cr>
	map <F11> :python3 debugger_context()<cr>
	map <F12> :python3 debugger_property()<cr>
	map <F11> :python3 debugger_watch_input("context_get")<cr>A<cr>
	map <F12> :python3 debugger_watch_input("property_get", '<cword>')<cr>A<cr>
	nnoremap ,e :python3 debugger_watch_input("eval")<cr>A
endif
